            ...
            if (copied_quote_info['is_template'].toLowerCase().trim() == 'yes') {
                ...
                let newRow = `
                        <tr id ="quote_id_${copied_quote_info['quote_id']}" class="text-danger">  
                            ...
                            <td class="border-0"><a href="/view_quote/${copied_quote_info['quote_name']}" type="button" class="btn btn-sm btn-info full-width p-0 m-0 visible-off"><small class=" pl-1 pr-1">View</small></a></td>
                            <td class="border-0"><a href="/edit_quote/${copied_quote_info['quote_id']}" type="button" class="btn btn-sm btn-success full-width p-0 m-0 visible-off"><small class=" pl-1 pr-1">Edit</small></a></td>
