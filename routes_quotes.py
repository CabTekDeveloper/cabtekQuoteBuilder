    ...
    try:
        if "user_info" in session:
            ...
            if request.method == "POST":
                ...
                copied_quote_id = quote_builder_db.get_quote_id_by_quote_name(new_quote_name)
                ...
                quote_builder_db.copy_quote_details_to_new_quote(original_quote_data, copied_quote_id)
                return jsonify({"success": True})
        else:
            return render_template("login_error.html")
    except Exception as ex:
